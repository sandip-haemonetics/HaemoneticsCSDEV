...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Case-HAE_Customer Service Community Claims Layout</layout>
        <recordType>Case.HAE_Customer_Service_Claims</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-HAE_Customer Service Community Inquiry Layout</layout>
        <recordType>Case.HAE_Customer_Service_Inquiry</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-HAE_Customer Service Community Order Layout</layout>
